...
class BaseMLLogger(logging.Logger):
    ...
    def make_rotation_handler(self, log_file_name):
        ...
        log_folder = os.environ['EZA_ML_LOG_FOLDER']
        ...
        # you can use RotatingFileHandler for paginate log files set values for quantity and file-size
        rot_handler = RotatingFileHandler(os.path.join(log_folder, log_file_name))
...
def make_formatter():
    ...
    app_version = ''
    if 'EZA_ML_APP_VERSION' in os.environ:
        app_version = os.environ['EZA_ML_APP_VERSION']
